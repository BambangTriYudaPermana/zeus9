...
<div class="app-header header">
    <div class="container-fluid">
        <div class="d-flex">
            ...
            {{-- <div class="main-header-center ms-3 d-none d-md-block" style="width: 120px; margin-top: 5px;">
                <button class="btn btn-sm btn-primary"><i class="fa fa-dollar"></i> <span id="wallet-user-general">{{Auth::user()->wallet}}</span></button>
            </div>     --}}
